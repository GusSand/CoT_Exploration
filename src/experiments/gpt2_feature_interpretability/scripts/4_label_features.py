...
Output: gpt2_labeled_features.json
"""
...
def label_all_features():
    ...
    with open('src/experiments/gpt2_feature_interpretability/data/gpt2_feature_token_correlations.json', 'r') as f:
        data = json.load(f)
    ...
    output_path = Path('src/experiments/gpt2_feature_interpretability/data/gpt2_labeled_features.json')
