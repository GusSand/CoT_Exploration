...
<head>
    ...
    <title>GPT-2 Feature Interpretability - Lightweight Dashboard</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <header>
            <h1>GPT-2 Feature Interpretability</h1>
        ...
        <div class="alert">
            ...
            <ul style="margin-top: 10px; margin-left: 20px;">
                <li><code>gpt2_labeled_features.json</code> - All 15,399 features with labels</li>
        ...
        <div class="section">
            ...
            <ul style="margin: 20px 0 0 20px; color: #a0aec0;">
                <li style="margin-bottom: 10px;">
                    <code>data/gpt2_labeled_features.json</code> (17.5 MB) - All features with labels and correlations
                </li>
                <li style="margin-bottom: 10px;">
