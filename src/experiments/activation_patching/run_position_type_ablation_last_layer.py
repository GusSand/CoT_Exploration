#!/usr/bin/env python3
"""
Position-type ablation experiment at LAST/LATE layer.
...
def run_gpt2_position_ablation_last_layer(max_samples=None):
    """Run GPT-2 position-type ablation at LAST layer (L11)."""
    print("=" * 70)
    print("GPT-2 POSITION-TYPE ABLATION - LAST LAYER (L11)")
    print("=" * 70)
    ...
    output_file = Path("/home/paperspace/dev/CoT_Exploration/src/experiments/gpt2_token_ablation/results/gpt2_position_ablation_last_layer.json")
    ...
    for sample in tqdm(samples, desc="GPT-2 Last Layer Ablation"):
        ...
        # Condition A: Ablate number positions at LAST layer
        ...
        # Condition B: Ablate non-number positions at LAST layer
    ...
    output = {
        'model': 'GPT-2',
        'ablation_layer': 'late (L11 - last layer)',
    ...
    # Print results
    print("\n" + "=" * 70)
    print("GPT-2 LAST LAYER RESULTS")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    run_gpt2_position_ablation_last_layer(max_samples=max_samples)
