...
Usage:
    python run_both_correct_experiment.py --model_path ~/codi_ckpt/gpt2_gsm8k/ \
                                           --problem_pairs data/problem_pairs.json \
                                           --output_dir results_both_correct/
"""
    ...
    def __init__(self, model_path: str, output_dir: str, wandb_project: str = None):
        ...
        if self.use_wandb:
            ...
            wandb.init(
                ...
                name="both-correct-patching-clean-to-corrupted",
                dir=str(SCRIPT_DIR / "wandb_runs"),
                config={
                    "experiment": "both_correct_activation_patching",
                    "model": model_path,
