#!/usr/bin/env python3
"""
Simplified CoT Necessity Test for GPT-2

Uses existing N-token ablation infrastructure to test if GPT-2 needs CoT.
...
def test_cot_necessity_gpt2():
    ...
    for pair in tqdm(pairs, desc="Testing CoT necessity"):
        try:
            ...
            for problem_type in ['clean', 'corrupted']:
                ...
                baseline_correct = pair['matched_validation']['gpt2'][f'{problem_type}_correct']
    ...
    # Print summary
    print("\n" + "="*80)
    print("GPT-2 COT NECESSITY TEST COMPLETE")
    print("="*80)
