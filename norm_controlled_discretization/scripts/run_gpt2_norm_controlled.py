#!/usr/bin/env python3
"""
CODI Discretization Analysis with NORM CONTROL - GPT-2 VERSION
...
parser.add_argument("--output_dir", type=str, default="./gpt2_norm_controlled_results", help="Output directory")
...
def main():
    print("="*80)
    print("CODI-GPT2 DISCRETIZATION ANALYSIS - NORM CONTROLLED VERSION")
    print("="*80)
    ...
    # Print summary
    print("\n" + "="*80)
    print("FINAL RESULTS - CODI-GPT2 NORM CONTROLLED")
    print("="*80)
    for mode in modes:
        s = stats[mode]
